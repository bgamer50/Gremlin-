...
inline GraphTraversal* fold() { return (new GraphTraversal())->fold(); }
...
inline GraphTraversal* unfold() { return (new GraphTraversal())->unfold(); }
...
inline GraphTraversal* valueMap(std::vector<std::string> labels) { return (new GraphTraversal())->valueMap(labels); }
